...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull LinearLayout rootView, @NonNull CheckBox cbMonitor,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.cbMonitor;
      CheckBox cbMonitor = ViewBindings.findChildViewById(rootView, id);
      if (cbMonitor == null) {
        break missingId;
      }
      ...
      return new ItemAppBinding((LinearLayout) rootView, cbMonitor, ivAppIcon, tvAppName,
          tvPackageName);
    }
